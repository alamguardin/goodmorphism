...
function CodeBlock({ properties }) {
    let codeString = useRef(strCodeGenerator(properties))

    useEffect(() => {
        codeString.current = strCodeGenerator(properties)
    }, [properties])

    const handleClick = () => {
        navigator.clipboard.writeText(codeString.current)
    }
    ...
    return (
        <div className="code">
            ...
            <button className="code__button" onClick={handleClick}>
